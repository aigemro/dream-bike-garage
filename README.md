...
Day 5마다 홈 달력에서 진입하는 `리버사이드 3K` 자동 레이스를 보상 메타 루프의 수직 슬라이스로 포함합니다. 레이스는 채택된 E안인 시네마틱 스포츠 중계형만 출시 흐름에 연결하며, 다른 연출 비교안은 Lab에 유지합니다.

자세한 내용은 [게임 콘셉트 문서](docs/game-design/GAME_CONCEPT.md), [MVP 범위](docs/game-design/MVP.md), [2026년 11월 출시 계획](docs/development/RELEASE_PLAN_2026_11.md)을 참고하세요.
