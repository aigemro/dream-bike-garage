...
- 주간 회의 운영: `docs/development/WEEKLY_SYNC.md` (매주 월요일 점심 진행 공유)
- 아키텍처: `docs/development/ARCHITECTURE.md`
- 웹·앱 화면 구조 전략: `docs/development/SCREEN_LAYOUT_STRATEGY.md` (앱인토스 앱 화면 대응, Lab 트랙 공통 화면 규격)
...
- MVP는 머지·주문·조립·컬렉션·드림 바이크 성장의 핵심 경험 검증에 집중합니다.
  매치3, 샵 경영, 실제 브랜드, 광고·인앱결제, 서버 동기화는 구현하지 않습니다. 레이스는 채택된 E안의 5일 주기 보상 수직 슬라이스만 포함합니다.
